...
This package (`Move_LookAtSmooth_002`) is the paid upgrade to `Move_LookAtSmooth_001` (the free version). It adds
...
This package uses the same class names and namespace as the free version (`Move_LookAtSmooth_001`).
**If you already have `Move_LookAtSmooth_001` in your project, please delete it before importing
`Move_LookAtSmooth_002`.** Importing both at the same time will cause compile errors due to duplicate
class definitions.
